...
"}")
    ...
    def SetPrevButtonDisable(self, disable):
            self.prev_Button.setDisabled(disable)

    def SetNextButtonDisable(self, disable):
    ...
    def retranslateUi(self, Dialog, data):
            ...
            self.jpg = QtGui.QPixmap(data[8]).scaled(self.label.width(), self.label.height())
...
if __name__ == '__main__':
    ...
    def test(index):
            ...
            content.retranslateUi(dialog, data)
            dialog.exec()
